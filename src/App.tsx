...
const donationTypes = [
  { id: "dime", name: "Dîme", icon: Church, description: "10% de vos revenus pour l'Église", color: "text-purple-600" },
  { id: "offering", name: "Offrande", icon: Heart, description: "Don libre pour l'œuvre de Dieu", color: "text-red-600" },
  { id: "alms", name: "Aumône", icon: HandHeart, description: "Pour les plus démunis", color: "text-green-600" },
  { id: "construction", name: "Construction", icon: Building2, description: "Pour l'entretien et la construction", color: "text-blue-600" },
  { id: "missions", name: "Missions", icon: Globe, description: "Soutien aux missionnaires", color: "text-orange-600" },
  { id: "social", name: "Œuvres sociales", icon: UsersRound, description: "Actions caritatives", color: "text-teal-600" },
];

// Moyens de paiement
const paymentMethods = [
  { id: "mtn", name: "MTN Mobile Money", icon: Smartphone, color: "bg-yellow-500" },
  { id: "moov", name: "Moov Money", icon: Smartphone, color: "bg-blue-500" },
  { id: "orange", name: "Orange Money", icon: Smartphone, color: "bg-orange-500" },
  { id: "card", name: "Carte bancaire", icon: CreditCard, color: "bg-purple-600" },
  { id: "mobile", name: "Mobile Money (générique)", icon: Smartphone, color: "bg-green-500" },
];

// Composant LandingPage (anciennement Home)
const LandingPage = ({ onDonate }: { onDonate: (name: string, city: string, amount: number, donationType: string, paymentMethod: string) => void }) => {
  ...
  const handleDonate = async () => {
    ...
    setTimeout(() => {
      ...
      onDonate(nomComplet, villeQuartier, amountNumber, donationTypeName, paymentMethodName);
            ...
            {[
              {
                icon: CreditCard,
                step: "1",
                title: "Choisissez un type de don et un montant",
              ...
              },
              {
                ...
                desc: "Donnez en toute confiance via MTN, Moov, Orange Money ou carte bancaire.",
              },
              {
                icon: Clock,
                step: "3",
        ...
        <div className="container mx-auto px-6">
          ...
          >
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {donationTypes.map((type) => (
                  ...
                  >
                    <type.icon className={`w-6 h-6 mx-auto mb-1 ${selectedDonationType === type.id ? type.color : "text-gray-500"}`} />
                    <p className={`text-sm font-medium ${selectedDonationType === type.id ? "text-purple-700" : "text-gray-700"}`}>
                      {type.name}
                    </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
                {paymentMethods.map((method) => (
                  ...
                  >
                    ...
                    <p className={`text-xs font-medium ${selectedPaymentMethod === method.id ? "text-purple-700" : "text-gray-700"}`}>
                      {method.name}
                    </p>
                  </button>
                ))}
            ...
            <button
              ...
              className={`w-full py-3 rounded-full transition flex items-center justify-center gap-2 shadow-md ${
            ...
            <p className="text-xs text-gray-500 text-center mt-4">
              Votre don est sécurisé. Vous recevrez un reçu par SMS et email.
            </p>
          </motion.div>
        </div>
      </section>
...
function App() {
  const [donations, setDonations] = useState<Donation[]>([
    { id: 1, name: "Jean Dupont", city: "Paris", amount: 500, date: new Date(2026, 2, 15), donationType: "Dîme", paymentMethod: "Carte bancaire" },
    { id: 2, name: "Marie Lambert", city: "Lyon", amount: 300, date: new Date(2026, 2, 10), donationType: "Offrande", paymentMethod: "MTN Mobile Money" },
    { id: 3, name: "Pierre Martin", city: "Marseille", amount: 200, date: new Date(2026, 2, 5), donationType: "Aumône", paymentMethod: "Orange Money" },
    { id: 4, name: "Sophie Bernard", city: "Bordeaux", amount: 1000, date: new Date(2026, 1, 28), donationType: "Missions", paymentMethod: "Carte bancaire" },
    { id: 5, name: "Lucas Moreau", city: "Lille", amount: 750, date: new Date(2026, 1, 20), donationType: "Construction", paymentMethod: "Moov Money" },
    { id: 6, name: "Élise Robert", city: "Toulouse", amount: 450, date: new Date(2026, 2, 18), donationType: "Œuvres sociales", paymentMethod: "Mobile Money" },
  ]);

  const addDonation = (name: string, city: string, amount: number, donationType: string, paymentMethod: string) => {
