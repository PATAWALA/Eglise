...
const App = () => {
  ...
  const handleDonate = () => {
    alert("Merci pour votre don ! Que Dieu vous bénisse abondamment.");
  };
      ...
      <nav className="fixed top-0 w-full bg-white/90 backdrop-blur-md shadow-sm z-50">
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t py-4 px-6 flex flex-col space-y-3">
            ...
            <button className="bg-purple-600 text-white px-5 py-2 rounded-full w-full text-center">Donner maintenant</button>
          </div>
        )}
      </nav>

      {/* Hero Section */}
      <section id="hero" className="pt-32 pb-20 bg-gradient-to-br from-purple-50 to-indigo-100">
        <div className="container mx-auto px-6 flex flex-col md:flex-row items-center">
          <motion.div {...fadeInUp} className="md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 leading-tight">
              Donnez avec joie, car <span className="text-purple-600">Dieu aime celui qui donne avec joie</span>
            </h1>
            ...
            <div className="mt-8 flex flex-wrap gap-4 justify-center md:justify-start">
              ...
              <button className="border border-purple-600 text-purple-600 px-8 py-3 rounded-full hover:bg-purple-50 transition">
                Lire la Parole
              </button>
            </div>
          </motion.div>
      ...
      <section id="why" className="py-20 bg-white">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-10 mt-16">
            {[
              { icon: BookOpen, title: "La dîme, un acte de foi", desc: "« Apportez à la maison du trésor toutes les dîmes… Et éprouvez-moi en cela, dit l’Éternel » (Malachie 3:10). Donner, c’est reconnaître que tout vient de Dieu." },
              { icon: Heart, title: "Suivre l’exemple de Jésus", desc: "Jésus a donné sa vie par amour. En donnant, nous imitons son cœur généreux et nous bénissons ceux qui souffrent." },
              { icon: Users, title: "Secourir les démunis", desc: "« Vous avez donné à manger à celui qui avait faim… c’est à moi que vous l’avez fait » (Matthieu 25:40). Vos dons soutiennent les familles dans le besoin." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, y: 30 }}
      ...
      <section id="how" className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          <motion.div {...fadeInUp} className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 mt-3">
              En trois étapes simples, vous pouvez bénir l’œuvre du Seigneur et vos frères dans le besoin.
            </p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-8 mt-16">
            {[
              { icon: CreditCard, step: "1", title: "Choisissez un montant", desc: "Que ce soit la dîme, une offrande ou un don pour les pauvres, Dieu regarde votre cœur." },
              { icon: Shield, step: "2", title: "Paiement sécurisé", desc: "Donnez en toute confiance, comme si vous déposiez votre offrande à l’église." },
              { icon: Clock, step: "3", title: "Confirmation et prière", desc: "Vous recevrez un reçu et nous prierons pour vous et vos intentions." },
            ].map((item, i) => (
              <motion.div
                key={i}
                initial={{ opacity: 0, scale: 0.9 }}
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="mt-6 md:mt-0 flex gap-6">
              ...
              <a href="#" className="text-gray-400 hover:text-white transition">Nous contacter</a>
            </div>
          </div>
